  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="products">
        <div class="cl">&nbsp;</div>
        <ul>
          <li><a href="#"><i class="none">!</i><img src="./Images/big1.jpg" alt="" /></a>
...
.products ul li{
  position:relative; padding:1px; border:solid 1px #dedede;
  float:left; width:231px; margin-right:9px; height:383px; overflow:hidden; }
